...
public class Mistral_ESP_kestrelmirv implements MissileAIPlugin, GuidedMissileAI {
    private CombatEngineAPI engine;
    private final MissileAPI missile;
    private final IntervalUtil intervalUtil = new IntervalUtil(1f, 1f);
    private boolean speedSet = false;

    public Mistral_ESP_kestrelmirv(MissileAPI missile) {
    ...
    private void mirv(MissileAPI missile) {
        ...
        CombatEntityAPI missile1 = Global.getCombatEngine().spawnProjectile(missile.getSource(), missile.getWeapon(), "diableavionics_mistral_esp_kestrel2", missile.getLocation(), missile.getFacing(), null);
        missile1.setMass(1);
